        ...
        <div className='px-[353px] py-[100px]'>
            ...
            <div className='px-[357px] flex flex-col gap-y-[30px] pt-[30px] '>
                ...
                <div className='flex justify-center'>
                    <Link href='/exchange-confirm'>
                        <Button size='medium'>Pay</Button>
                    </Link>
                </div>
                <div className='flex justify-center gap-x-[8px]'>
                    <Button size='medium' variant='secondary' className='border-[#CFCEDB] font-semibold '>
                    ...
                    <Button size='medium' variant='secondary' className='border-[#CFCEDB] font-semibold '>
                        <div className='flex flex-row justify-center items-center py-[13.5px] gap-x-[10px]'>
                            <Google/>
