...
const HomePage = () => {
    return (
        <div className='overflow:hidden pb-[100px] pt-[91px] lg:pb-[150px] lg:pt-[158px] md:pt-[211px]'>
            {/* Основний контент */}
            <div className='md:overflow-hidden lg:overflow-visible'>
                ...
                <div className="flex flex-col md:flex-row items-center md:justify-between lg:max-w-[1420px] md:mx-auto md:max-w-[1013px] md:pl-8 md:px-0 px-4 lg:pb-[272px] md:pb-[297px] pb-[100px]">
                    {/* Зображення ведмедя */}
                    <Image
                        width={1920}
                        height={1080}
            ...
            <div className='flex flex-col mx-auto items-center md:justify-between md:mx-auto md:flex-row lg:max-w-[1180px] md:max-w-[861px] max-w-full lg:gap-x-[52px] md:gap-x-[35px] lg:px-[0px] md:px-[32px] px-[16px]'>
                <ThemedText type='title_currency' className='text-wrap md:text-left text-center order-1 md:order-2'>
