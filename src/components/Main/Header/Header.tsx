        ...
        <>
            ...
            <header className='shadow-header sm:shadow-none sm:border-b sm:border-white-200 h-fit'>
                <nav className='overflow-visible'>
                    <div className='px-4 md:px-[32px] w-full max-w-[1420px] mx-auto py-2 sm:py-3 md:py-4 lg:py-[14px] flex flex-row sm:flex-row md:justify-between lg:gap-x-12'>
                        <MobileHeader
                            isOpen={isOpen}
                            setIsOpen={onOpenSettings}
                        />
                        <div className='gap-x-[83px] md:flex flex-col sm:flex-col md:flex-row justify-center items-center md:gap-x-[40px] hidden'>
                            <Image
                                width={1920}
                                height={1080}
                                src='/IMG_5815 (1).png'
