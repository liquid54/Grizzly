    ...
    return (
        <div className='flex flex-col items-center gap-y-[30px]'>
            ...
            <div className='flex flex-col gap-y-[10px] items-center'>
                ...
                <ThemedText className='text-center'>Your exchange has been successfully processed! The funds will now be
                    transferred to your provided details. The processing time depends on the payment system and network
                    load. If you do not receive the funds within the expected timeframe, please contact our support
                    team. Thank you for choosing our service!</ThemedText>
            </div>
            <div className='flex flex-col gap-y-[10px] items-center'>
